...
import { LanguageProvider } from "@/components/mini-components/lang/LanguageContext"
...
export default function App() {
  ...
  return (
    <LanguageProvider>
      {isDarkMode ? <Particles className="fixed inset-0 -z-10" quantity={120} /> : <ParticlesLight className="fixed inset-0 -z-10" quantity={120} />}
